...
int main(int argc, char* argv[]) {
	...
	auto _ = bserv::server{ config, {
		...
		bserv::make_path("/users/<int>", &view_users,
			...
			bserv::placeholders::response,
			bserv::placeholders::_1),
		bserv::make_path("/musics", &view_musics,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session,
			bserv::placeholders::response,
			std::string{"1"}),

		bserv::make_path("/musics/<int>", &view_musics,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session,
			bserv::placeholders::response,
			bserv::placeholders::_1),
		...
		bserv::make_path("/comments/<int>", &view_comments,
			...
			bserv::placeholders::response,
			bserv::placeholders::_1),
		bserv::make_path("/comments/searchs", &view_searchs,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session,
			bserv::placeholders::response,
			bserv::placeholders::json_params,
		...
		bserv::make_path("/dmusic", &delete_music,
			bserv::placeholders::request,
			bserv::placeholders::response,
			bserv::placeholders::json_params,
			bserv::placeholders::db_connection_ptr,
		...
		bserv::make_path("/dcomment", &delete_comment,
			bserv::placeholders::request,
			bserv::placeholders::response,
			bserv::placeholders::json_params,
			bserv::placeholders::db_connection_ptr,
